...
export default class ModalDropdown extends Component {
  ...
  _renderButton() {
    const { disabled, accessible, children, textStyle, buttonTextColor } = this.props;
      ...
      >
        {
          children ||
          (
            <View style={[styles.button, { flex: 1, flexDirection: 'row' }]}>
              <Text style={[styles.buttonText, textStyle, { color: 'gray', fontFamily: 'Roboto-Bold', }]}
                numberOfLines={1}
              >
                {buttonText}
              </Text>

              <Icon name="arrow-up" style={{ color: 'gray', justifyContent: 'center', paddingHorizontal: 0, paddingTop: 5 }} />
  ...
  _calcPosition() {
    ...
    //positionStyle.top += 36.5;
    positionStyle.top += 105;
