...
import {en_ca_PP, fr_ca_PP} from '@constants/HtmlTexts';

const en_PrivacyPolicy =
  Platform.OS === 'ios'
    ? {html: en_ca_PP}
    : {uri: 'file:///android_asset/privacy_en-ca.html'};
const fr_PrivacyPolicy =
  Platform.OS === 'ios'
    ? {html: fr_ca_PP}
    : {uri: 'file:///android_asset/privacy_fr-ca.html'};
